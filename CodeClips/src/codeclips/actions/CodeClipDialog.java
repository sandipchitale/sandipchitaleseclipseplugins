...
//	private Text contentTypeText;
	...
	public CodeClipDialog(Shell parentShell, Shell contextShell, TemplatePersistenceData templatePersistenceData) {
		super(parentShell);
	...
	public CodeClipDialog(Shell parentShell, Shell contextShell) {
		super(parentShell);
		this.contextShell = contextShell;
...
//		contentType = contentTypeText.getText().trim();
	...
	protected void createButtonsForButtonBar(Composite parent) {
		if (getParentShell() == contextShell) {
			...
			manageButton.addSelectionListener(new SelectionListener() {
				public void widgetSelected(SelectionEvent e) {
					new ManageCodeClipsDialog(getShell(), contextShell).open();
				}
