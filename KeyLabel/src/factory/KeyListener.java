...
class KeyListener implements AWTEventListener {
	...
	private static String getKeyText(KeyEvent keyEvent) {
		...
		if (keyChar != KeyEvent.CHAR_UNDEFINED && keyChar != KeyEvent.VK_SPACE && keyChar != KeyEvent.VK_TAB && keyChar != KeyEvent.VK_ENTER && keyChar != KeyEvent.VK_BACK_SPACE && keyChar != KeyEvent.VK_DELETE && keyChar != KeyEvent.VK_ESCAPE && ((!keyEvent.isAltDown()) && (!keyEvent.isControlDown()) && (!keyEvent.isMetaDown()))) {
			sb.append("" + keyChar);
